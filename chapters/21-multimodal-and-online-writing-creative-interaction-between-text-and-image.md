# Chapter 21 — Multimodal and Online Writing
...
```
I'm composing a multimodal advocacy piece for a college writing class.
The piece will combine some mix of text, image, audio, video, and
...
1. Ask me four diagnostic questions about my audience. Who
   specifically? Where do they consume content? What do they already
   believe about this issue? What would shift their willingness to
   take the action?

2. Based on my answers, propose two or three genres that would fit
   this audience and this argument — blog post, photo essay,
   podcast, video essay, social media sequence, infographic, etc.
   For each, name what about my audience and argument makes it
   appropriate.

3. Once I've chosen a genre, help me break down what each mode in
   that genre is going to be doing. For a photo essay: what role
   for image, what role for caption, what role for sequence. For a
   podcast: what role for voice, what role for sound, what role for
   silence. The mode breakdown should make each element's job
   specific.

4. Ask me about accessibility. Captions? Alt text? Transcripts?
   Color contrast? Font size? Loading on low-bandwidth connections?
   Treat each as a structural decision, not a feature.

5. Identify what kind of source material I will need to produce
   myself versus what I can find or license. For original material,
   suggest what to collect.

Do not draft the piece. Do not produce sample text, images, audio,
